...
const db = {
  ...
  getWorkerNotifications: (workerId) => workerNotifications.filter(n => n.workerId === workerId && !n.read),
  addWorkerNotification: (workerId, type, message) => {
    const n = { id: uuid(), workerId, type, message, read: false, createdAt: new Date().toISOString() };
